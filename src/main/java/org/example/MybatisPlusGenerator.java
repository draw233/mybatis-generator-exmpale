...
public class MybatisPlusGenerator {
    ...
    private static final DataSourceConfig.Builder DATA_SOURCE_CONFIG = new DataSourceConfig
            .Builder("jdbc:mysql://localhost:3306/demo?useUnicode=true&useJDBCCompliantTimezoneShift=true" +
            "&useLegacyDatetimeCode=false&serverTimezone=UTC", "root", "admin123")
...
//                        .author(scanner.apply("请输入开发者名称："))//作者名，baomidou 默认值:作者
                        .author("luck")//作者名，baomidou 默认值:作者
...
//                        .enableActiveRecord()//开启 ActiveRecord 模型，默认值:false
                        ...
                        .formatFileName("%sPO")//格式化文件名称，生成实体的后缀，建议这样使用，生成后：UserLoginBean
